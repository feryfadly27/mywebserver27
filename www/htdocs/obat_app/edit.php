...
// Ambil data lama
$stmtOld = $pdo->prepare("SELECT * FROM `obat` WHERE `id` = :id");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            $sql = "UPDATE `obat` SET `kode_obat` = :kode_obat, `nama_obat` = :nama_obat, `stok` = :stok, `harga_beli` = :harga_beli, `harga_jual` = :harga_jual, `tgl_kadaluarsa` = :tgl_kadaluarsa, `status_obat` = :status_obat, `kategori` = :kategori, `kategori_id` = :kategori_id WHERE `id` = :primary_id";
            ...
            header("Location: index.php?pesan=Data+berhasil+diperbarui!&tipe=success");
            exit;
        ...
        <div class="card card-custom">
            <div class="card-header bg-white border-bottom p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold mb-0"><i class="bi bi-pencil-square text-primary me-2"></i>Ubah Data obat</h5>
            ...
            <div class="card-body p-4">
                ...
                <form method="POST" action="edit.php?id=<?= urlencode($id) ?>">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= isset($errors['kode_obat']) ? 'is-invalid' : '' ?>" id="kode_obat" name="kode_obat" value="<?= htmlspecialchars($values['kode_obat'] ?? '') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= isset($errors['nama_obat']) ? 'is-invalid' : '' ?>" id="nama_obat" name="nama_obat" value="<?= htmlspecialchars($values['nama_obat'] ?? '') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="1" class="form-control <?= isset($errors['stok']) ? 'is-invalid' : '' ?>" id="stok" name="stok" value="<?= htmlspecialchars($values['stok'] ?? '') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control <?= isset($errors['harga_beli']) ? 'is-invalid' : '' ?>" id="harga_beli" name="harga_beli" value="<?= htmlspecialchars($values['harga_beli'] ?? '') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control <?= isset($errors['harga_jual']) ? 'is-invalid' : '' ?>" id="harga_jual" name="harga_jual" value="<?= htmlspecialchars($values['harga_jual'] ?? '') ?>">
